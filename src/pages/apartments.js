  ...
  return (
    <div className="apartments-list">
      <div className="apartment-carousel">
        <Slider {...settings}>
          <div className="apartment-carousel__item">
            ...
            <figure>
              <img src={ApartmentFigure} alt="" />
            </figure>
            <h4 className="category">SL</h4>
          </div>
          <div className="apartment-carousel__item">
            <div className="apartment-carousel__title">
              <h1>
            ...
            <figure>
              <img src={ApartmentFigure2} alt="" />
            </figure>
            <h4 className="category">A2+</h4>
          </div>
          <div className="apartment-carousel__item">
            <div className="apartment-carousel__title">
              <h1>
          ...
          <div className="apartment-carousel__item">
            <div className="apartment-carousel__title">
              <h1>
                Apartamento
                <span>2H – 2B Plus</span>
              </h1>
            </div>
            <figure>
              <img src={ApartmentFigure2} alt="" />
            </figure>
            <h4 className="category">A1</h4>
          </div>
          <div className="apartment-carousel__item">
            <div className="apartment-carousel__title">
              <h1>
