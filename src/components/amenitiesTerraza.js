...
import PoolFigure01 from "../assets/pool-figure01.webp";
import PoolFigure02 from "../assets/pool-figure02.webp";
import Terraza from "../assets/terraza.webp";
                        ...
                        <div className='lg-blog__inner'>
                            <div className='info-blog__text-area'>
                                <h2 className='info-blog__title maximum'>
                                    Placerat eleifend ligula, Cras in molestie
                                    velit
                                </h2>
                                <h4 className='dsc maximum'>
                                    El Counter Lobby Quisque vitae suscipit
                                    justo. Cras fringilla, ligula ultricies
                                    rutrum consequat, quam dui sagittis enim,
                                    condimentum euismod nulla nunc a lacus.
                                    Vestibulum in ex id elit aliquam lacinia.
                                    Fusce vitae magna in libero porta porta a
                                    nec neque.
                                </h4>
            ...
            <section className='facility-blog bottom info-blog left-space'>
                <div className='inner-section'>
                    <div className='info-blog__text-area'>
                        ...
                        <h4 className='dsc'>
                            Proin hendrerit, nulla id convallis ultrices, lacus
                            risus suscipit dui, eu auctor sem nulla et nibh.
                            Aenean eu semper dui, sit amet vulputate metus
                            vestibulum fringilla nisl.
                        </h4>
                    </div>
